...
echo ""
echo "NOTE: MCP Agent workflow (2u3IEwTXbPa58Tyw) uses OpenClaw OpenAI credential (J4U9S3zNh5bhlnRs)"
echo "      Enter your OpenAI API key: n8n Cloud UI > Credentials > OpenClaw OpenAI"
echo ""
echo "MCP Streamable HTTP Endpoints (used by n8n Code Tools):"
echo "  POST http://72.62.255.251:{port}/mcp with JSON-RPC body"
echo "  Ports: yahoo-finance=3100, basic-memory=3101, memory=3102, fetch=3103, obsidian=3104"
